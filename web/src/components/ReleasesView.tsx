...
// the GitHub Releases API for malcolmston/jwt.
const RELEASE_LIBS: RelLib[] = [
  { name: JWT.name, icon: JWT.icon, accent: JWT.accent, repo: ghrepo(JWT), url: JWT.repo },
];
